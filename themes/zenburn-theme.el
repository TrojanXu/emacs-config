...
;;;;; font lock
   ...
   `(font-lock-function-name-face ((t (:foreground ,zenburn-cyan :weight bold))))
   `(font-lock-keyword-face ((t (:foreground ,zenburn-magenta :weight bold))))
